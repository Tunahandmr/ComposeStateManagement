package com.tunahan.retrofitcompose
...
import com.tunahan.retrofitcompose.service.CryptoAPI
import com.tunahan.retrofitcompose.ui.theme.RetrofitComposeTheme
import retrofit2.*
...
fun AppBar(){
    ...
    TopAppBar(contentPadding = PaddingValues(5.dp)) {
        Text(text = "Retrofit Compose", fontSize = 20.sp)
    }
}
...
fun DefaultPreview() {
    RetrofitComposeTheme {
       CryptoRow(crypto = CryptoModel("BTC","123456"))
    }
}